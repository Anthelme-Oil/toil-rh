...
const SALLES_INITIALES = [
  {
    code: 'GRANDE_SALLE',
    nom: 'La grande salle de réunion',
    capacite: 30,
  ...
  {
    code: 'HALL_DG',
    nom: 'La salle de réunion Hall DG',
    capacite: 12,
  ...
  {
    code: 'HALL_FINANCE',
    nom: 'La salle de réunion Hall Finance',
    capacite: 10,
  ...
  },
  {
    ...
    nom: 'La salle de réunion Hall Commercial',
    capacite: 10,
  ...
  {
    code: 'HALL_OPERATION',
    nom: 'La salle de réunion Hall Opération',
    capacite: 15,
  ...
  {
    code: 'JURIDIQUE',
    nom: 'La salle de réunion Juridique',
    capacite: 8,
