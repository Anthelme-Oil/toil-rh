...
/** Icône placeholder pour les news sans image */
function NewsPlaceholder({ categorie }: { categorie?: string }) {
  ...
  return (
    <div
      className={`w-16 h-16 rounded-xl bg-gradient-to-br ${gradient} flex items-center justify-center flex-shrink-0`}
    >
...
export default function ActualitesSection({ actualites }: ActualitesSectionProps) {
  return (
    <div
      className="bg-white rounded-xl p-5 card-hover animate-fade-in-up"
